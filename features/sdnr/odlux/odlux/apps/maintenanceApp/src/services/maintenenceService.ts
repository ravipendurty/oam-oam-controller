...
const MaintenenceService = {
  /**
  * Adds maintenence entry to the backend.
  */
  writeMaintenenceEntry: async (maintenenceEntry: MaintenanceEntry): Promise<PostResponse | null> => {
  ...
  /**
  * Updates maintenence entry to the backend.
  */
  updateMaintenenceEntry: async (maintenenceEntry: MaintenanceEntry): Promise<PostResponse | null> => {
    const path = '/rests/operations/data-provider:update-maintenance';
    const query = {
      'id': maintenenceEntry.mId,
      'node-id': maintenenceEntry.nodeId,
      'active': maintenenceEntry.active,
  ...
  */
  deleteMaintenenceEntry: async (maintenenceEntry: MaintenanceEntry): Promise<(DeleteResponse) | null> => {
