...
type RefreshEventLogDialogComponentProps = {
  mode: RefreshEventLogDialogMode;
  onClose: () => void;
};

const RefreshEventLogDialogComponent: FC<RefreshEventLogDialogComponentProps> = (props) => {
  const dispatch = useApplicationDispatch();
  const refreshEventLog = () => dispatch(eventLogReloadAction);
  ...
  return (
    <Dialog open={props.mode !== RefreshEventLogDialogMode.None}>
...
export const RefreshEventLogDialog = RefreshEventLogDialogComponent;
