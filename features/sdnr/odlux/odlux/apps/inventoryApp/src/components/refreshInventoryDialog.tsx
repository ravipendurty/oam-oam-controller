...
type RefreshInventoryDialogComponentProps = {
  mode: RefreshInventoryDialogMode;
  onClose: () => void;
};

const RefreshInventoryDialogComponent: FC<RefreshInventoryDialogComponentProps> = (props) => {
  const dispatch = useApplicationDispatch();
  const refreshInventory = () => dispatch(inventoryElementsReloadAction);
  ...
  return (
    <Dialog open={props.mode !== RefreshInventoryDialogMode.None}>
...
export const RefreshInventoryDialog = RefreshInventoryDialogComponent;
