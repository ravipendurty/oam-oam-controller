...
/**
 * Represents a web api accessor service for all maintenance entries related actions.
 */
const InventoryService = {
  getInventoryTree: async (mountId: string, searchTerm: string = ''): Promise<InventoryTreeNode | null> => {
  ...
  getInventoryEntry: async (id: string): Promise<InventoryType | undefined> => {
   ...
   */
  getInventoryDeviceList: async (): Promise<(InventoryDeviceListType)[] | null> => {
