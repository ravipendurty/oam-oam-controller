...
deploy:
	mvn clean install -f parents/pom.xml -s settings.xml -Dmaven.repo.local=${GITHUB_WORKSPACE}/m2repo
	mvn clean install -f features/sdnr/wt/pom.xml -s settings.xml -Dmaven.repo.local=${GITHUB_WORKSPACE}/m2repo
	mvn clean install -f features/sdnr/odlux/pom.xml -s settings.xml -Dmaven.repo.local=${GITHUB_WORKSPACE}/m2repo
	mvn clean install -f distribution/oam-controller/pom.xml -s settings.xml -Dmaven.repo.local=${GITHUB_WORKSPACE}/m2repo
